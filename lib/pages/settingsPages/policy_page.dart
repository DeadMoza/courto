...
Text(
  ...
  '⸻\n'
  '1. التعريفات\n'
  '• التطبيق: تطبيق كورتو (Courto) الخاص بحجز الملاعب الرياضية (قدم، كرة، سلة، بادمنتون وغيرها).\n'
  ...
  '• رسوم الحجز المبدئية: المبلغ الذي يدفعه المستخدم عبر التطبيق لتأكيد الحجز (5 د.ل لكل ساعة).\n'
  '• المبلغ المتبقي: المبلغ الذي يدفعه المستخدم لصاحب الملعب مباشرة عند الوصول إلى الموقع.\n'
  '⸻\n'
  '2. آلية الحجز والدفع\n'
  '1. يقوم المستخدم باختيار الملعب والوقت والتاريخ المناسب للحجز من خلال التطبيق.\n'
  '2. بعد إرسال الطلب، لا يتم خصم أي مبلغ مالي مباشرة من المستخدم حتى يقوم صاحب الملعب بقبول الحجز.\n'
  '3. بمجرد قبول صاحب الملعب، يتم خصم رسوم الحجز المبدئية (5 د.ل لكل ساعة) من وسيلة الدفع المسجلة لدى المستخدم.\n'
  ...
  '⸻\n'
  '4. الإلغاء والاسترجاع\n'
  '1. لا يمكن للمستخدم إلغاء الحجز إلا قبل مرور ساعة واحدة على إنشاء الحجز، وذلك لمنع تكرار عمليات الإلغاء العشوائية.\n'
